...
enum StringID
{
    ...
    STRINGID_RULEWASVIOLATED,
    STRINGID_NOVALIDENCOUNTER_DUPE,
    STRINGID_NOVALIDENCOUNTER_METLOC,
    STRINGID_BATTLERULE_NONE,
    STRINGID_BATTLERULE_BANNEDTYPE,
    STRINGID_BATTLERULE_BANNEDMOVETYPE,
    STRINGID_BATTLERULE_NOHEALING,
    STRINGID_BATTLERULE_NOCRITS,
    STRINGID_BATTLERULE_NORECOIL,
    STRINGID_BATTLERULE_NOSTAB,
    STRINGID_BATTLERULE_ONLYSTAB,
    STRINGID_BATTLERULE_NOSUPEREFFECTIVE,
    STRINGID_BATTLERULE_1HP,
    STRINGID_BATTLERULE_1PP,
    STRINGID_BATTLERULE_NOSAMESEX,
    STRINGID_BATTLERULE_NOSWITCHING,
    STRINGID_BATTLERULE_PERISHCOUNT,
    STRINGID_BATTLERULE_SWITCHMOVES,
    STRINGID_BATTLERULE_NOPRIO,
    STRINGID_BATTLERULE_NOHELDITEMS,
    STRINGID_BATTLERULE_NOABILITY,
    STRINGID_BATTLERULE_NOSTATUS,
    // STRINGID_BATTLERULE_SHAREDDAMAGE,
    STRINGID_BATTLERULE_NOSETUP,
    STRINGID_BATTLERULE_TRICKROOM,
    STRINGID_BATTLERULE_BANNEDMOVECAT_PHYSICAL,
    STRINGID_BATTLERULE_BANNEDMOVECAT_SPECIAL,
    STRINGID_BATTLERULE_BANNEDMOVECAT_STATUS,
    STRINGID_BATTLERULE_INVERSE,
    STRINGID_BATTLERULE_FIRSTMOVEONLY,
    STRINGID_BATTLERULE_TRUANT,
    STRINGID_BATTLERULE_NOMISSES,
    STRINGID_DONTLEAVETUTORIAL,
    STRINGID_PLAYERLOST_TUTORIAL,
    STRINGID_COUNT
};
