...
struct SaveBlock3
{
    ...
    u8 metLocsInitialized; // 1 byte marker for save file compatibility, can be used as versioning for future save block updates
}; /* max size 1624 bytes */
...
struct SaveBlock2
{
    ...
    u8 randomSpeciesType[TRAINERS_COUNT];
}; // sizeof=0xF2C
...
struct SaveBlock1
{
    ...
    /*0x988*/ u8 debugBattleRule[3];
              u8 filler1[0x31]; // Previously Dex Flags, feel free to remove.
#endif //FREE_EXTRA_SEEN_FLAGS_SAVEBLOCK1
    /*0x9BC*/ u16 berryBlenderRecords[3];
    /*0x9C2*/ u8 filler2;
              u16 battleRuleRerollCounter;
              u8 typeRerollCounter;
              u16 lastTrainerId;
