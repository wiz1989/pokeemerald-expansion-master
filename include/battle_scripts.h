...
extern const u8 BattleScript_EarlyRivalBattleLost[];
...
extern const u8 BattleScript_PrintCantRunFromTutorial[];
...
extern const u8 BattleScript_NoValidEncounter_Dupe[];
extern const u8 BattleScript_NoValidEncounter_MetLoc[];
