...
#define I_SELL_VALUE_FRACTION           GEN_5  // In Gen9+, items sell for 1/4 of their value instead of 1/2.
#define I_PRICE                         GEN_5  // Some items have varied in value across generations.
