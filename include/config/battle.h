...
#define B_FLAG_NO_BAG_USE           FLAG_NO_BAG_IN_BATTLE // If this flag is set, the ability to use the bag in battle is disabled.
...
#define B_BATTLE_SPEED              VAR_BATTLE_SPEED // battle speed up
...
#define B_SANDSTORM_SPDEF_BOOST         GEN_5 // In Gen4+, Sandstorm weather multiplies the Sp. Defense of Rock-type Pokémon by x1.5.
...
#define B_SECRET_POWER_EFFECT       GEN_5 // Secret Power's effects change depending on terrain and generation. See MOVE_EFFECT_SECRET_POWER's case in `SetMoveEffect`.
#define B_SECRET_POWER_ANIMATION    GEN_5 // Secret Power's animations change depending on terrain and generation.
#define B_NATURE_POWER_MOVES        GEN_5 // Nature Power calls different moves depending on terrain and generation. See gBattleEnvironmentInfo.
