...
#ifdef RELEASE
  #define DEBUG_BATTLE_BASE_DATA_DISPLAY_ONLY  TRUE    // If set to TRUE, the battle debug menu only offer to display the movesets of the AI. Everything else can't be used.
#else
  #define DEBUG_BATTLE_BASE_DATA_DISPLAY_ONLY  FALSE   // If set to TRUE, the battle debug menu only offer to display the movesets of the AI. Everything else can't be used.
#endif
