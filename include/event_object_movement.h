...
extern const union AnimCmd *const sAnimTable_Following_WalkRun[];
...
bool8 CopyablePlayerMovement_Jump4(struct ObjectEvent *objectEvent, struct Sprite *sprite, enum Direction, bool8 tileCallback(u8));
