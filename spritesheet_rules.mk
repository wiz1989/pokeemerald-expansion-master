...
$(OBJEVENTGFXDIR)/misc/shark.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/people/fisherman_rod_south.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/misc/celebi.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4

$(OBJEVENTGFXDIR)/misc/corphish.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
