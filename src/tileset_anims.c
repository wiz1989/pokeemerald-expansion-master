...
static void TilesetAnim_Island(u16);
...
static void QueueAnimTiles_Island_Water(u16);
...
const u16 gTilesetAnims_General_Water_Frame0[] = INCBIN_U16("data/tilesets/primary/general/anim/water_old/0.4bpp");
const u16 gTilesetAnims_General_Water_Frame1[] = INCBIN_U16("data/tilesets/primary/general/anim/water_old/1.4bpp");
const u16 gTilesetAnims_General_Water_Frame2[] = INCBIN_U16("data/tilesets/primary/general/anim/water_old/2.4bpp");
const u16 gTilesetAnims_General_Water_Frame3[] = INCBIN_U16("data/tilesets/primary/general/anim/water_old/3.4bpp");
const u16 gTilesetAnims_General_Water_Frame4[] = INCBIN_U16("data/tilesets/primary/general/anim/water_old/4.4bpp");
const u16 gTilesetAnims_General_Water_Frame5[] = INCBIN_U16("data/tilesets/primary/general/anim/water_old/5.4bpp");
const u16 gTilesetAnims_General_Water_Frame6[] = INCBIN_U16("data/tilesets/primary/general/anim/water_old/6.4bpp");
const u16 gTilesetAnims_General_Water_Frame7[] = INCBIN_U16("data/tilesets/primary/general/anim/water_old/7.4bpp");

const u16 gTilesetAnims_Island_Water_Frame0[] = INCBIN_U16("data/tilesets/primary/general/anim/water/0.4bpp");
const u16 gTilesetAnims_Island_Water_Frame1[] = INCBIN_U16("data/tilesets/primary/general/anim/water/1.4bpp");
const u16 gTilesetAnims_Island_Water_Frame2[] = INCBIN_U16("data/tilesets/primary/general/anim/water/2.4bpp");
const u16 gTilesetAnims_Island_Water_Frame3[] = INCBIN_U16("data/tilesets/primary/general/anim/water/3.4bpp");
const u16 gTilesetAnims_Island_Water_Frame4[] = INCBIN_U16("data/tilesets/primary/general/anim/water/4.4bpp");
const u16 gTilesetAnims_Island_Water_Frame5[] = INCBIN_U16("data/tilesets/primary/general/anim/water/5.4bpp");
const u16 gTilesetAnims_Island_Water_Frame6[] = INCBIN_U16("data/tilesets/primary/general/anim/water/6.4bpp");
const u16 gTilesetAnims_Island_Water_Frame7[] = INCBIN_U16("data/tilesets/primary/general/anim/water/7.4bpp");
...
const u16 *const gTilesetAnims_Island_Water[] = {
    gTilesetAnims_Island_Water_Frame0,
    gTilesetAnims_Island_Water_Frame1,
    gTilesetAnims_Island_Water_Frame2,
    gTilesetAnims_Island_Water_Frame3,
    gTilesetAnims_Island_Water_Frame4,
    gTilesetAnims_Island_Water_Frame5,
    gTilesetAnims_Island_Water_Frame6,
    gTilesetAnims_Island_Water_Frame7
};
...
void InitTilesetAnim_Island(void)
{
    sPrimaryTilesetAnimCounter = 0;
    sPrimaryTilesetAnimCounterMax = 256;
    sPrimaryTilesetAnimCallback = TilesetAnim_Island;
}
...
static void TilesetAnim_Island(u16 timer)
{
    if (timer % 16 == 0)
        QueueAnimTiles_General_Flower(timer / 16);
    if (timer % 16 == 1)
        QueueAnimTiles_Island_Water(timer / 16);
    //if (timer % 16 == 2)
    //    QueueAnimTiles_General_SandWaterEdge(timer / 16);
    //if (timer % 16 == 3)
    //    QueueAnimTiles_General_Waterfall(timer / 16);
...
static void QueueAnimTiles_General_Water(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_General_Water[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(432)), 30 * TILE_SIZE_4BPP); //30
}

static void QueueAnimTiles_Island_Water(u16 timer)
{
    u8 i = timer % ARRAY_COUNT(gTilesetAnims_Island_Water);
    AppendTilesetAnimToBuffer(gTilesetAnims_Island_Water[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(416)), 34 * TILE_SIZE_4BPP); //30
}
