...
static void SaveOptions(u8 taskId)
{
    ...
    gSaveBlock2Ptr->revealRule = (gTasks[taskId].tRevealRule > 0);
...
{
    u8 styles[3];
    s32 widthSlow, widthMid, widthInst, xMid;
    ...
    widthMid -= 94;
    xMid = (widthSlow - widthMid - widthInst) / 2 + 104;
...
static void PermaDeath_DrawChoices(u8 selection)
{
    ...
    styles[1] = 0;
    styles[selection] = 1;
    DrawOptionMenuChoice(gText_PermaDeathOff, 104, YPOS_PERMADEATH, styles[0]);
    DrawOptionMenuChoice(gText_PermaDeathOn, GetStringRightAlignXOffset(FONT_NORMAL, gText_PermaDeathOn, 198), YPOS_PERMADEATH, styles[1]);
}
...
static void RevealRule_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_OptionOn, 129, YPOS_REVEALRULE, styles[1]);
    DrawOptionMenuChoice(gText_OptionAnnounce, GetStringRightAlignXOffset(FONT_NORMAL, gText_OptionAnnounce, 198), YPOS_REVEALRULE, styles[2]);
}
