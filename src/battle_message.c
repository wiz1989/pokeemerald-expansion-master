...
static const u8 sText_CantCatchSpeciesTwice[] = _("You can't catch a species twice!\pBetter save your Pokéballs then.");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_CANTCATCHSPECIESTWICE - BATTLESTRINGS_TABLE_START] = sText_CantCatchSpeciesTwice,
