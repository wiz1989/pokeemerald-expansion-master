...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_BATTLERULE_NONE]                      = COMPOUND_STRING("Rule: No Rule active"),
    [STRINGID_BATTLERULE_BANNEDTYPE]                = COMPOUND_STRING("Rule: Banned Type {STR_VAR_2}"),
    [STRINGID_BATTLERULE_BANNEDMOVETYPE]            = COMPOUND_STRING("Rule: Banned Move Type {STR_VAR_2}"),
    [STRINGID_BATTLERULE_NOHEALING]                 = COMPOUND_STRING("Rule: No Healing"),
    [STRINGID_BATTLERULE_NOCRITS]                   = COMPOUND_STRING("Rule: No Critical Hits"),
    [STRINGID_BATTLERULE_NORECOIL]                  = COMPOUND_STRING("Rule: No Recoil"),
    [STRINGID_BATTLERULE_NOSTAB]                    = COMPOUND_STRING("Rule: No STAB"),
    [STRINGID_BATTLERULE_ONLYSTAB]                  = COMPOUND_STRING("Rule: Only STAB"),
    [STRINGID_BATTLERULE_NOSUPEREFFECTIVE]          = COMPOUND_STRING("Rule: No Super Effective Moves"),
    [STRINGID_BATTLERULE_1HP]                       = COMPOUND_STRING("Rule: 1 HP"),
    [STRINGID_BATTLERULE_1PP]                       = COMPOUND_STRING("Rule: 1 PP"),
    [STRINGID_BATTLERULE_NOSAMESEX]                 = COMPOUND_STRING("Rule: No Same Sex Genders"),
    [STRINGID_BATTLERULE_NOSWITCHING]               = COMPOUND_STRING("Rule: No Switching"),
    [STRINGID_BATTLERULE_PERISHCOUNT]               = COMPOUND_STRING("Rule: Perish Count"),
    [STRINGID_BATTLERULE_SWITCHMOVES]               = COMPOUND_STRING("Rule: No Repeating Moves"),
    [STRINGID_BATTLERULE_NOPRIO]                    = COMPOUND_STRING("Rule: No Priority"),
    [STRINGID_BATTLERULE_NOHELDITEMS]               = COMPOUND_STRING("Rule: No Held Items"),
    [STRINGID_BATTLERULE_NOABILITY]                 = COMPOUND_STRING("Rule: No Abilities"),
    [STRINGID_BATTLERULE_NOSTATUS]                  = COMPOUND_STRING("Rule: No Status Effects"),
    //[STRINGID_BATTLERULE_SHAREDDAMAGE]              = COMPOUND_STRING("Rule: Shared Damage"),
    [STRINGID_BATTLERULE_NOSETUP]                   = COMPOUND_STRING("Rule: No Setup Moves"),
    [STRINGID_BATTLERULE_TRICKROOM]                 = COMPOUND_STRING("Rule: Trick Room"),
    [STRINGID_BATTLERULE_BANNEDMOVECAT_PHYSICAL]    = COMPOUND_STRING("Rule: No Physical Moves"),
    [STRINGID_BATTLERULE_BANNEDMOVECAT_SPECIAL]     = COMPOUND_STRING("Rule: No Special Moves"),
    [STRINGID_BATTLERULE_BANNEDMOVECAT_STATUS]      = COMPOUND_STRING("Rule: No Status Moves"),
    [STRINGID_BATTLERULE_INVERSE]                   = COMPOUND_STRING("Rule: Inverse Battle"),
