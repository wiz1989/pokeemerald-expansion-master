...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_RULEWASVIOLATED]                      = COMPOUND_STRING("A BATTLE RULE WAS VIOLATED!"),
    [STRINGID_NOVALIDENCOUNTER_DUPE]                = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} is no valid encounter (dupe)!"),
    [STRINGID_NOVALIDENCOUNTER_METLOC]              = COMPOUND_STRING("You have already had an encounter here!"),
    [STRINGID_BATTLERULE_NONE]                      = COMPOUND_STRING("Rule: No Rule active\p"),
    [STRINGID_BATTLERULE_BANNEDTYPE]                = COMPOUND_STRING("Rule: Banned Type {STR_VAR_2}\p"),
    [STRINGID_BATTLERULE_BANNEDMOVETYPE]            = COMPOUND_STRING("Rule: Banned Move Type {STR_VAR_2}\p"),
    [STRINGID_BATTLERULE_NOHEALING]                 = COMPOUND_STRING("Rule: No Healing\p"),
    [STRINGID_BATTLERULE_NOCRITS]                   = COMPOUND_STRING("Rule: No Critical Hits\p"),
    [STRINGID_BATTLERULE_NORECOIL]                  = COMPOUND_STRING("Rule: No Recoil\p"),
    [STRINGID_BATTLERULE_NOSTAB]                    = COMPOUND_STRING("Rule: No STAB\p"),
    [STRINGID_BATTLERULE_ONLYSTAB]                  = COMPOUND_STRING("Rule: Only STAB\p"),
    [STRINGID_BATTLERULE_NOSUPEREFFECTIVE]          = COMPOUND_STRING("Rule: No Super Effective Moves\p"),
    [STRINGID_BATTLERULE_1HP]                       = COMPOUND_STRING("Rule: 1 HP\p"),
    [STRINGID_BATTLERULE_1PP]                       = COMPOUND_STRING("Rule: 1 PP\p"),
    [STRINGID_BATTLERULE_NOSAMESEX]                 = COMPOUND_STRING("Rule: No Same Sex Genders\p"),
    [STRINGID_BATTLERULE_NOSWITCHING]               = COMPOUND_STRING("Rule: No Switching\p"),
    [STRINGID_BATTLERULE_PERISHCOUNT]               = COMPOUND_STRING("Rule: Perish Count\p"),
    [STRINGID_BATTLERULE_SWITCHMOVES]               = COMPOUND_STRING("Rule: No Repeating Moves\p"),
    [STRINGID_BATTLERULE_NOPRIO]                    = COMPOUND_STRING("Rule: No Priority\p"),
    [STRINGID_BATTLERULE_NOHELDITEMS]               = COMPOUND_STRING("Rule: No Held Items\p"),
    [STRINGID_BATTLERULE_NOABILITY]                 = COMPOUND_STRING("Rule: No Abilities\p"),
    [STRINGID_BATTLERULE_NOSTATUS]                  = COMPOUND_STRING("Rule: No Status Effects\p"),
    //[STRINGID_BATTLERULE_SHAREDDAMAGE]              = COMPOUND_STRING("Rule: Shared Damage"),
    [STRINGID_BATTLERULE_NOSETUP]                   = COMPOUND_STRING("Rule: No Setup Moves\p"),
    [STRINGID_BATTLERULE_TRICKROOM]                 = COMPOUND_STRING("Rule: Trick Room\p"),
    [STRINGID_BATTLERULE_BANNEDMOVECAT_PHYSICAL]    = COMPOUND_STRING("Rule: No Physical Moves\p"),
    [STRINGID_BATTLERULE_BANNEDMOVECAT_SPECIAL]     = COMPOUND_STRING("Rule: No Special Moves\p"),
    [STRINGID_BATTLERULE_BANNEDMOVECAT_STATUS]      = COMPOUND_STRING("Rule: No Status Moves\p"),
    [STRINGID_BATTLERULE_INVERSE]                   = COMPOUND_STRING("Rule: Inverse Battle\p"),
    [STRINGID_BATTLERULE_FIRSTMOVEONLY]             = COMPOUND_STRING("Rule: First Move Only\p"),
    [STRINGID_BATTLERULE_TRUANT]                    = COMPOUND_STRING("Rule: Truant\p"),
    [STRINGID_BATTLERULE_NOMISSES]                  = COMPOUND_STRING("Rule: No Misses\p"),
...
const u16 gRestoreHPStringIds[] =
{
    [B_MSG_ITEM_RESTORED_SPECIES_HEALTH] = STRINGID_ITEMRESTOREDSPECIESHEALTH,
    [B_MSG_BATTLERULE_VIOLATION]         = STRINGID_RULEWASVIOLATED,
};
...
const u16 gBattleRulesStringIds[] =
{
    [BATTLERULE_NONE] = STRINGID_BATTLERULE_NONE,
    [BATTLERULE_BANNEDTYPE] = STRINGID_BATTLERULE_BANNEDTYPE,
    [BATTLERULE_BANNEDMOVETYPE] = STRINGID_BATTLERULE_BANNEDMOVETYPE,
    [BATTLERULE_NOHEALING] = STRINGID_BATTLERULE_NOHEALING,
    [BATTLERULE_NOCRITS] = STRINGID_BATTLERULE_NOCRITS,
    [BATTLERULE_NORECOIL] = STRINGID_BATTLERULE_NORECOIL,
    [BATTLERULE_NOSTAB] = STRINGID_BATTLERULE_NOSTAB,
    [BATTLERULE_ONLYSTAB] = STRINGID_BATTLERULE_ONLYSTAB,
    [BATTLERULE_NOSUPEREFFECTIVE] = STRINGID_BATTLERULE_NOSUPEREFFECTIVE,
    [BATTLERULE_1HP] = STRINGID_BATTLERULE_1HP,
    [BATTLERULE_1PP] = STRINGID_BATTLERULE_1PP,
    [BATTLERULE_NOSAMESEX] = STRINGID_BATTLERULE_NOSAMESEX,
    [BATTLERULE_NOSWITCHING] = STRINGID_BATTLERULE_NOSWITCHING,
    [BATTLERULE_PERISHCOUNT] = STRINGID_BATTLERULE_PERISHCOUNT,
    [BATTLERULE_SWITCHMOVES] = STRINGID_BATTLERULE_SWITCHMOVES,
    [BATTLERULE_NOPRIO] = STRINGID_BATTLERULE_NOPRIO,
    [BATTLERULE_NOHELDITEMS] = STRINGID_BATTLERULE_NOHELDITEMS,
    [BATTLERULE_NOABILITY] = STRINGID_BATTLERULE_NOABILITY,
    [BATTLERULE_NOSTATUS] = STRINGID_BATTLERULE_NOSTATUS,
    // [BATTLERULE_SHAREDDAMAGE] = STRINGID_BATTLERULE_SHAREDDAMAGE,
    [BATTLERULE_NOSETUP] = STRINGID_BATTLERULE_NOSETUP,
    [BATTLERULE_TRICKROOM] = STRINGID_BATTLERULE_TRICKROOM,
    [BATTLERULE_BANNEDMOVECAT_PHYSICAL] = STRINGID_BATTLERULE_BANNEDMOVECAT_PHYSICAL,
    [BATTLERULE_BANNEDMOVECAT_SPECIAL] = STRINGID_BATTLERULE_BANNEDMOVECAT_SPECIAL,
    [BATTLERULE_BANNEDMOVECAT_STATUS] = STRINGID_BATTLERULE_BANNEDMOVECAT_STATUS,
    [BATTLERULE_INVERSE] = STRINGID_BATTLERULE_INVERSE,
    [BATTLERULE_FIRSTMOVEONLY] = STRINGID_BATTLERULE_FIRSTMOVEONLY,
    [BATTLERULE_TRUANT] = STRINGID_BATTLERULE_TRUANT,
    [BATTLERULE_NOMISSES] = STRINGID_BATTLERULE_NOMISSES,
};
