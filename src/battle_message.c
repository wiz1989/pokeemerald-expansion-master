...
static const u8 sText_WildPkmnAppeared[] = _("{B_OPPONENT_MON1_NAME} wants to battle!");
...
const u8 gText_ChooseWeather[] = _("Choose weather with L/R!\nOr press A to continue.");
