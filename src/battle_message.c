...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_NOVALIDENCOUNTER_METLOC]              = COMPOUND_STRING("You have alreada had an encounter here!"),
    ...
    [STRINGID_BATTLERULE_SWITCHMOVES]               = COMPOUND_STRING("Rule: Switch Moves"),
