...
static bool8 ShouldDoSlideInAnim(u32 battler)
{
    ...
    if (gBattleTypeFlags & (
        BATTLE_TYPE_LINK | BATTLE_TYPE_DOUBLE | BATTLE_TYPE_FRONTIER | BATTLE_TYPE_FIRST_BATTLE | BATTLE_TYPE_FIRST_BATTLE_RIVAL |
...
{
    u8 battleSceneOption = VarGet(B_BATTLE_SPEED);
