static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_NATIONAL_HISTORY_MUSEUM - 1] = {MAP_GROUP(NATIONAL_HISTORY_MUSEUM_L2), MAP_NUM(NATIONAL_HISTORY_MUSEUM_L2), 22, 4},
    [HEAL_LOCATION_NATIONAL_HISTORY_MUSEUM_F1 - 1] = {MAP_GROUP(NATIONAL_HISTORY_MUSEUM_L1), MAP_NUM(NATIONAL_HISTORY_MUSEUM_L1), 4, 14},
};
