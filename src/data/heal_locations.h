static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_TARC_ISLAND - 1] = {MAP_GROUP(TARC_ISLAND), MAP_NUM(TARC_ISLAND), 20, 25},
    [HEAL_LOCATION_TARC_SEA - 1] = {MAP_GROUP(TARC_SEA), MAP_NUM(TARC_SEA), 30, 17},
    [HEAL_LOCATION_TARC_ISLAND_2 - 1] = {MAP_GROUP(TARC_ISLAND), MAP_NUM(TARC_ISLAND), 38, 11},
    [HEAL_LOCATION_TARC_UNDERWATER - 1] = {MAP_GROUP(TARC_UNDERWATER), MAP_NUM(TARC_UNDERWATER), 23, 33},
};
