...
static const struct SpriteFrameImage sPicTable_Starlight[] = {
    overworld_ascending_frames(gObjectEventPic_Starlight, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Leob[] = {
    overworld_ascending_frames(gObjectEventPic_Leob, 2, 4),
};
