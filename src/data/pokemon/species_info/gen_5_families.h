...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_WOOBAT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_SWOOBAT, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD})},
                                {EVO_LEVEL, 0, SPECIES_SWOOBAT, CONDITIONS({IF_HOLD_ITEM, ITEM_SOOTHE_BELL})}),
    },
    ...
    [SPECIES_SWADLOON] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_LEAVANNY, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD})},
                                {EVO_LEVEL, 0, SPECIES_LEAVANNY, CONDITIONS({IF_HOLD_ITEM, ITEM_SOOTHE_BELL})}),
    },
    ...
    {
        .family = SPECIES_BASCULIN_RED_STRIPED,
        .baseHP        = 70,
        .baseAttack    = 92,
        .baseDefense   = 65,
        .baseSpeed     = 98,
    ...
    {
        .family = SPECIES_DEERLING_SPRING,
        .baseHP        = 60,
        .baseAttack    = 60,
        .baseDefense   = 50,
        .baseSpeed     = 75,
    ...
    {
        .family = SPECIES_TORNADUS_INCARNATE,
        .baseHP        = 79,
        .baseAttack    = 115,
        .baseDefense   = 70,
        .baseSpeed     = 111,
    ...
    {
        .family = SPECIES_THUNDURUS_INCARNATE,
        .baseHP        = 79,
        .baseAttack    = 115,
        .baseDefense   = 70,
        .baseSpeed     = 111,
    ...
    {
        .family = SPECIES_LANDORUS_INCARNATE,
        .baseHP        = 89,
        .baseAttack    = 125,
        .baseDefense   = 90,
        .baseSpeed     = 101,
    ...
    {
        .family = SPECIES_KELDEO_ORDINARY,
        .baseHP        = 91,
        .baseAttack    = 72,
        .baseDefense   = 90,
        .baseSpeed     = 108,
