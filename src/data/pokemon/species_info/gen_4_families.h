...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_BUNEARY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_LOPUNNY, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD})},
                                {EVO_LEVEL, 0, SPECIES_LOPUNNY, CONDITIONS({IF_HOLD_ITEM, ITEM_SOOTHE_BELL})}),
    },
    ...
    [SPECIES_RIOLU] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_LUCARIO, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD},{IF_NOT_TIME, TIME_NIGHT})},
                                {EVO_LEVEL, 0, SPECIES_LUCARIO, CONDITIONS({IF_HOLD_ITEM, ITEM_SOOTHE_BELL},{IF_NOT_TIME, TIME_NIGHT})}),
    },
    ...
    {
        .family = SPECIES_GIRATINA_ALTERED,
        .baseHP        = 150,
        .baseAttack    = 100,
        .baseDefense   = 120,
        .baseSpeed     = 90,
