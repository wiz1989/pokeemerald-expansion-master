...
static bool8 StartMenuQoLHubCallback(void);
...
static const struct MenuAction sStartMenuItems[] =
{
    ...
    [MENU_ACTION_QOL_HUB]         = {gText_MenuQoLHub,  {.u8_void = StartMenuQoLHubCallback}},
...
static void BuildNormalStartMenu(void)
{
    ...
    AddStartMenuAction(MENU_ACTION_QOL_HUB);
...
static bool8 HandleStartMenuInput(void)
{
    ...
    if (JOY_NEW(A_BUTTON))
    {
        ...
        if (gMenuCallback != StartMenuSaveCallback
            ...
            && gMenuCallback != StartMenuQoLHubCallback)
        {
...
static void ShowSaveInfoWindow(void)
{
    ...
    // Print game version
    yOffset += 16;
    AddTextPrinterParameterized(sSaveInfoWindowId, FONT_NORMAL, gText_SavingVersion, 0, yOffset, TEXT_SKIP_DRAW, NULL);
