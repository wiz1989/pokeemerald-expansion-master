...
const u8 gText_HarderTrainersOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_HarderTrainersOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
...
const u8 gText_SavingVersion[] = _("Version: 0.9.0");
