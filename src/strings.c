...
const u8 gText_ThisIsAPokemon[] = _("(The rest is vanilla text.)\nThis is what we call a “POKéMON.”{PAUSE 96}\p");
...
const u8 gText_StarterPkmn[] = _("STARTER POKéMON");
...
const u8 gText_OptionMenuCancel[] = _("SAVE & EXIT");
const u8 gText_BattleSpeedup[] = _("BATTLE SPEEDUP");
...
const u8 gText_AnnounceRules[] = _("ANNOUNCE RULES");
const u8 gText_ConcurrentRules[] = _("CONCURRENT RULES");
const u8 gText_InstaTrigger[] = _("INSTA TRIGGER");
const u8 gText_ActivateNoCrits[] = _("NO-CRITS RULE");
const u8 gText_DupeClause[] = _("DUPE CLAUSE");
const u8 gText_MetLocClause[] = _("METLOC CLAUSE");
...
const u8 gText_PermaDeathOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_PermaDeathOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_BattleSpeedup1x[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}1x");
const u8 gText_BattleSpeedup2x[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}2x");
const u8 gText_BattleSpeedup3x[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}3x");
const u8 gText_BattleSpeedup4x[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}4x");
const u8 gText_ConcurrentRules1[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}1");
const u8 gText_ConcurrentRules2[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}2");
const u8 gText_ConcurrentRules3[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}3");
const u8 gText_NoBagInBattleOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
...
const u8 gText_OptionActive[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ACTIVE");
const u8 gText_OptionInactive[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}INACTIVE");
...
const u8 gText_MenuQoLHub[] = _("QoL Hub");
...
const u8 gText_SavingVersion[] = _("Version: " GAME_VERSION_STRING);
...
const u8 gText_NoCrits[] = _("No Crits");
const u8 gText_NoRecoil[] = _("No Recoil");
const u8 gText_NoStab[] = _("No STAB");
const u8 gText_OnlyStab[] = _("Only STAB");
const u8 gText_NoSuperEffective[] = _("No Super Eff.");
const u8 gText_1HPOnly[] = _("1HP only");
const u8 gText_1PPOnly[] = _("1PP only");
const u8 gText_DifferentGender[] = _("Diffrt. Gender");
const u8 gText_NoSwitching[] = _("No Switching");
const u8 gText_PerishCount[] = _("Perish Count");
const u8 gText_SwitchMoves[] = _("Switch Moves");
const u8 gText_NoPrioMoves[] = _("No Prio Moves");
const u8 gText_NoHeldItems[] = _("No Held Items");
const u8 gText_NoAbilities[] = _("No Abilities");
const u8 gText_NoStatus[] = _("No Status Cond.");
const u8 gText_SharedDamage[] = _("Shared Damage");
const u8 gText_NoSetup[] = _("No Setup Moves");
const u8 gText_TrickRoom[] = _("Trick Room");
const u8 gText_NoPhysicalMoves[] = _("No Physical Moves");
const u8 gText_NoSpecialMoves[] = _("No Special Moves");
const u8 gText_NoStatusMoves[] = _("No Status Moves");
const u8 gText_InverseBattle[] = _("Inverse Battle");
const u8 gText_FirstSlot[] = _("First Move Slot");
const u8 gText_Truant[] = _("Truant");
const u8 gText_NoMisses[] = _("No Misses");
