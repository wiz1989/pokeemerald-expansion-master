...
const u8 gText_ThisIsAPokemon[] = _("I will give you all information you\nmay need to start your adventure.{PAUSE 96}\p");
...
const u8 gText_NoMoreFish[] = _("There seems to be no more\nfish in this pond.\pI wonder who took them...{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TrainerCardHint1[] = _("Dear Diary,");
const u8 gText_TrainerCardHint2[] = _("I love my Pokédex so much!");
const u8 gText_DexHintTitle[] = _("          HINT");
const u8 gText_DexHintDescription[] = _("This sounds interesting...");
