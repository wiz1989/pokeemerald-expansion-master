...
void DrawHeaderBox(void)
{
    ...
    */
    ...
    SetWindowTemplateFields(&template, 0, 1, 7, 5, 5, 15, 8);
    ...
    ShowItemIconSprite(item, TRUE, handleFlash, 32, 81);
    //AddTextPrinterParameterized(sHeaderBoxWindowId, 0, dst, ITEM_ICON_X + 2, textY, 0, NULL);
    //AddTextPrinterParameterized(sHeaderBoxWindowId, 0, NULL, ITEM_ICON_X + 2, textY, 0, NULL);
}
